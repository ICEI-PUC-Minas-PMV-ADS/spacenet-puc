...
Funcionários, com excessão  do setor de suporte, poderão abrir chamados de TI para atender as suas necessidades.
...
O funcionário que abriu um chamado de TI poderá visualizar o andamento da solução e a sua resposta, que foi fornecida pelo setor responsávavel - suporte.
...
A tela inicial conterá apenas chamadas para as notícias mais relevantes, ou adicionadas por último. No entanto, para visualiza-las, os funcionários deverão clicar no menu superior, sendo redirecionado para a tela de notícias.
